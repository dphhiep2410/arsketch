...
public class RotateZoomImageView extends AppCompatImageView implements View.OnTouchListener {
    ...
    public void moveToCenter() {
        parms = (RelativeLayout.LayoutParams) getLayoutParams();
        ...
        parms.leftMargin = (width - parms.width) / 2;
        parms.topMargin = (height - parms.height) / 3;
...
//        BitmapDrawable bm = (BitmapDrawable)view.getDrawable();
//        if(bm != null){
