...
import com.libads.databinding.CustomNativeAdsStyle2Binding

class NativeAdStyle2(context: Context, attrs: AttributeSet?) :
    MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsStyle2Binding =
        CustomNativeAdsStyle2Binding.inflate(LayoutInflater.from(context), this, true)
