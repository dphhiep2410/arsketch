...
import com.libads.databinding.CustomNativeAdsStyle1Binding

class NativeAdStyle1(context: Context, attrs: AttributeSet?) :
    MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsStyle1Binding =
        CustomNativeAdsStyle1Binding.inflate(LayoutInflater.from(context), this, true)
    ...
    override fun getAdvertiser(): AppCompatTextView?= mViewBinding.adviser
}