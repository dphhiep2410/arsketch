...
import com.libads.databinding.CustomNativeAdsIntroBinding
import com.libads.databinding.CustomNativeAdsStyle3Binding

class NativeAdIntro(context: Context, attrs: AttributeSet?) :
    MLBBaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsIntroBinding =
        CustomNativeAdsIntroBinding.inflate(LayoutInflater.from(context), this, true)
